...
def init(*args, **kwargs):
    ...
    """
    assert (
        "tensorboard_mode" not in kwargs
    ), "We don't allow any overwrite for tensorboard_mode"
    kwargs = dict(kwargs)
    kwargs["tensorboard_mode"] = det.core._tensorboard_mode.TensorboardMode.MANUAL
    return det.core.init(*args, **kwargs)
